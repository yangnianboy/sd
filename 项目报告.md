...
2. 支持 12 种不同的几何变换类型
3. 通过内存优化策略，使系统可在消费级 GPU (12GB+) 上运行
4. 提供完整的命令行工具和动画生成功能
...
1. **三视角/四视角支持**: 扩展至更多视角的错觉生成
2. **交互式界面**: 开发 Web UI 提升用户体验
3. **实时预览**: 在低分辨率阶段提供快速预览
4. **自定义变换**: 支持用户自定义几何变换矩阵
5. **批量生成**: 支持多组提示词的批量处理
...
**项目仓库**: https://github.com/dangeng/visual_anagrams
